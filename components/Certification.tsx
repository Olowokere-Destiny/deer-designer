    ...
    <section className="w-full bg-[#F5EDE0] px-8 py-20 md:px-16 lg:px-24">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-16 md:gap-24">
        ...
        <div className="flex-1">
          <Image src={certBadge} alt="Board Certified badge" className="" />
        </div>

        {/* Right — copy */}
        <div className="max-w-lg">
          <h2
            className={`${cormorant.className} text-[clamp(1.9rem,3.5vw,2.8rem)] leading-[1.2] text-[#2b2118] mb-6 text-center lg:text-left`}
          >
            <em className="italic font-normal">Caring Representation Led By</em>
            <br />
            <span className="not-italic font-normal text-[#C49E78]">
              Board-Certified Specialists
            </span>
          </h2>

          <p
            className={`${cormorant.className} text-[1rem] font-light leading-[1.8] text-[#2b2118]/75 mb-4`}
          >
            ...
            you. At Deer Designer Family Law, PLLC., we understand the turmoil
            you are going through, and we are committed to guiding you toward
            the best resolution possible.
          </p>

          <p
            className={`${cormorant.className} text-[1rem] font-light leading-[1.8] text-[#2b2118]/75 mb-10`}
          >
            ...
            includes other board-certified family law specialists as well. You
          ...
          <a
            ...
            className={`${aboreto.className} inline-flex items-center gap-3 text-[#16191F] text-[0.6rem] tracking-[0.18em] px-6 py-4 bg-[#C49E78]`}
          >
